  ...
  return (
    <>
      <section className="relative py-20 md:py-32 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden min-h-[600px]">
        ...
        <button 
          onClick={goToNext}
          className="absolute right-4 top-[70%] md:top-1/2 transform -translate-y-1/2 z-30 bg-white/80 hover:bg-white/90 text-primary p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 backdrop-blur-sm"
        ...
        <div className="relative z-20 max-w-7xl mx-auto">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8 md:mt-0">
              <Button 
                size="lg" 
                className="bg-primary hover:bg-primary/90 text-white font-semibold shadow-lg px-4 sm:px-8"
